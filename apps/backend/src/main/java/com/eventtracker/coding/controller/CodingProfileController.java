package com.eventtracker.coding.controller;
...
@Tag(name = "Coding Profile", description = "Coding platform profiles (LeetCode), verification, stats, and history")
public class CodingProfileController {
    ...
    @Operation(summary = "Synchronize coding stats", description = "Fetches the latest stats from the coding platform and records a history snapshot")
