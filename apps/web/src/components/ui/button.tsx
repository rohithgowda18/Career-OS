...
function Button({
  ...
  if (variant === "default" || !variant) {
    themeClasses = themeTokens.buttonPrimary;
  } else if (variant === "secondary" || variant === "outline") {
    themeClasses = themeTokens.buttonSecondary;
  }

  // Base border radius classes to apply only if theme is not brutalist/apple/glass
  const defaultRadiusClass = (variant === "default" || variant === "secondary" || variant === "outline")
    ? "" 
    : "rounded-md";
