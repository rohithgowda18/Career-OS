...
import { getLoginUrl } from "@/constants/app-const";
  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        ...
        >
          <SidebarHeader className="h-16 justify-between px-2">
          ...
          {/* SidebarFooter removed in favor of top-right header profile icon */}
        </Sidebar>
        <div
